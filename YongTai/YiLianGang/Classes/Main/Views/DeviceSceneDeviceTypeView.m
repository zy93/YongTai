...
-(void)sendRequestWithIndex:(NSInteger)index{
    ...
    [self.requestTool sendGetRequestWithExStr:@"Service_Platform/group/deviceList.do" andParam:@{@"userId":[LoginNewTool sharedLoginNewTool].userID,@"groupId":self.groupId}];
}
