...
-(void)sendRequestToGetAllDeviceWithGroupId:(NSNumber *)groupId Response:(DeviceBlock)deviceBlock{
    ...
    NSLog(@"userid:%@",[LoginNewTool sharedLoginNewTool].userID);
    [self.allDeviceRequest sendGetRequestWithExStr:@"Service_Platform/group/deviceList.do" andParam:@{@"userId":[LoginNewTool sharedLoginNewTool].userID,@"groupId":groupId}];
