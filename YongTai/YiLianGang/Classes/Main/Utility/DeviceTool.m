...
//                                               andParam:@{@"userId":[LoginTool sharedLoginTool].userID}];
    //修改后的
//    [self.allDeviceGroupRequest sendGetRequestWithExStr:@"Service_Platform/group/all.do"
//                                                    andParam:@{@"userId":[LoginNewTool sharedLoginNewTool].userID}];
...
-(NSArray*)deviceSegmentTitlesAddWithStr:(NSString*)str{
    ...
    [self.addRequst sendPostRequestWithExStr:@"Service_Platform/group/add.do" andParam:@{@"userId":[NSNumber numberWithInt:[LoginNewTool sharedLoginNewTool].userID.intValue],@"groupName":str}];
...
-(void)sendInfoWithThingId:(NSString *)thingId response:(DeleteDeviceBlock)block{
    ...
    [self.deleteDeviceRequest sendPostJsonRequestWithExStr:@"Service_Platform/pe/delete.do" andParam:@{@"thingId":thingId,@"userId":[LoginNewTool sharedLoginNewTool].userID}];
...
-(void)sendPermissionWithThingId:(NSString *)thingId userTel:(NSString *)tel state:(BOOL)isPermission response:(PermissionDeviceBlock)block
{
    ...
    [self.permissionDeviceRequest sendPostRequestWithExStr:@"Service_Platform/thing/thingPermission.do" andParam:@{@"userId":[LoginNewTool sharedLoginNewTool].userID, @"state":@(state), @"permissionUser":tel, @"thingId":thingId}];
