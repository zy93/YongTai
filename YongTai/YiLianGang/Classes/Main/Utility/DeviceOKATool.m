...
-(void)sendRequestToGetOKAListWithResponse:(OKABlock)block{
    ...
    [self.getRequest sendGetRequestWithExStr:@"Service_Platform/scene/all.do" andParam:@{@"userId":[LoginNewTool sharedLoginNewTool].userID}];
...
-(void)sendRequestToRegisterOKAWithName:(NSString *)name services:(NSArray<DeviceSceneCooperationService*>*)serviceArr response:(OKABlock)block{
    ...
    NSNumber *userId = [NSNumber numberWithInteger:[LoginNewTool sharedLoginNewTool].userID.integerValue];
