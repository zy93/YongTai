...
-(void)sendRequestGetAllDeviceScene{
    ...
    [[DeviceSceneTool sharedDeviceSceneTool]sendRequestToGetAllDeviceSceneWithUserId:[NSNumber numberWithInteger:[LoginNewTool sharedLoginNewTool].userID.integerValue] response:^(NSArray<DeviceSceneInfo *> *infoArr) {
