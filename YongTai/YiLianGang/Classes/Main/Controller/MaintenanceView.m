...
-(void)commitContent:(UIButton *)sender
{
    if ([fileDic allKeys].count == 0) {
        [MBProgressHUDUtil showMessage:@"请选择图片后提交！" toView:self];
        return;
    }
    ...
    {
        NSString *alias= [NSString stringWithFormat:@"%@B",[[[NSUserDefaults standardUserDefaults] objectForKey:@"userInfo"] objectForKey:@"mobile"]];
...
//                              @"appointmentTime":[self cutOutTimeString:_lab2.titleLabel.text]};
        NSDictionary *dic = @{@"name":[[[NSUserDefaults standardUserDefaults] objectForKey:@"userInfo"] objectForKey:@"name"],
                              @"content":mTextView.text,
                              @"address":self.adressTextField.text,
                              @"areaId":[[[NSUserDefaults standardUserDefaults] objectForKey:@"userInfo"] objectForKey:@"areaId"],
                              @"houseId":[[[NSUserDefaults standardUserDefaults] objectForKey:@"userInfo"] objectForKey:@"houseId"],
                              @"houseName":[[[NSUserDefaults standardUserDefaults] objectForKey:@"userInfo"] objectForKey:@"houseName"],
                              @"tel":self.telTextField.text,
                              @"alias":alias
                                  };
        NSLog(@"参数：%@",dic);
        //NSString *url = [NSString stringWithFormat:@"%@KP/info/info_intoInfo",HTTP_Service];
        NSString *url = [NSString stringWithFormat:@"%@Yongtai_community/Repairsinfo/addRepairs",@"http://www.yiliangang.net:8012/"];
        //NSString *url = [NSString stringWithFormat:@"%@Yongtai_community/Repairsinfo/addRepairs",@"http://192.168.34.80:8080/"];
